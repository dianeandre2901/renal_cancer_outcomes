...
for epoch in range(epochs):
    ...
    plt.tight_layout()
    plt.savefig(f"results/plots/CNN_binary_images50+tab_slide_confusion_matrix_epoch{epoch + 1}.png")
    plt.close(fig)
    ...
    plt.tight_layout()
    plt.savefig(f"results/plots/CNN_binary_images+tab50_slide_ROC_epoch{epoch + 1}.png")
    plt.close()
    print(f"Saved ROC curve as results/plots/CNN_binary_images+tab50_slide_ROC_epoch{epoch + 1}.png")
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "model_CNN_binary_images+tab50.pth")
    else:
