"""
CNN Cox Model with images and tabular features. 50 training slides - 100 validation slides
...
for epoch in range(epochs):
    ...
    if cindex > best_val_cindex:
        ...
        torch.save(model.state_dict(), "cox_images50.pth")
    else:
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/train_val_loss_acc_cox_images50.pdf")
plt.close()
print("Saved train/val loss & acc plot to results/plots/train_val_loss_cox_images50.png")
...
if best_model_state is not None:
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("results/plots/cox_images50_cstat_curve.png")
    plt.close()
...
# Save to file
with open("results/plots/cox_images50_runtime.txt", "w") as f:
