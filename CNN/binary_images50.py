...
for epoch in range(epochs):
    ...
    plt.tight_layout()
    plt.savefig(f"results/plots/CNN_binary_images50_slide_confusion_matrix_epoch{epoch + 1}.png")
    plt.close(fig)
    print(f"Saved confusion matrix as results/plots/CNN_binary_images50_slide_confusion_matrix_epoch{epoch + 1}.png/pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images50_train_val_loss_acc.png")
plt.close()
print("Saved train/val loss & acc plot to results/plots/CNN_binary_images50_train_val_loss_acc.png")
...
plt.close()
print("Saved loss calibration plot to results/plots/CNN_binary_images50_train_val_loss_separate.png")
...
plt.close()
print("Saved accuracy calibration plot to results/plots/CNN_binary_images50_train_val_acc_separate.png")
...
# Save to file
with open("results/plots/CNN_binary_images50_runtime_aftertuning.txt", "w") as f:
