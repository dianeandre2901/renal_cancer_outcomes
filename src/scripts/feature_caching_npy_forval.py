...
# ==== CONFIG ====
PATCH_COORDS_CSV = "/rds/general/user/dla24/home/thesis/src/scripts/results/patch_coords_val.csv"  # or patch_coords_val.csv
OUTPUT_DIR = "features_train_validation"  # or features_val
