...
first_20_train = train_patches[train_patches['slide_id'].isin(train_patches['slide_id'].unique()[:30])]
...
for epoch in range(epochs):
    ...
    plt.close(fig)
    print(f"Saved confusion matrix as results/plots/CNN_binary_images+tab20_slide_confusion_matrix_epoch{epoch + 1}.png")
