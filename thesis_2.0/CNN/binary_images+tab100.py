...
first_100_val   = val_patches[val_patches['slide_id'].isin(val_patches['slide_id'].unique()[:40])]
...
for epoch in range(epochs):
    ...
    plt.tight_layout()
    plt.savefig(f"results/plots/CNN_binary_images+tab100_slide_confusion_matrix_epoch{epoch + 1}.png")
    plt.close(fig)
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "model_CNN_binary_images100.pth")
    else:
...
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images+tab100_final_slide_ROC.png")
plt.close()
print("Saved final ROC curve as results/plots/CNN_binary_images+tab100_final_slide_ROC.png")
...
plt.close()
print("Saved train/val loss & acc plot to results/plots/CNN_binary_images+tab100_train_val_loss_acc.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images+tab100_train_val_loss_separate.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images+tab100_train_val_acc_separate.png")
plt.close()
print("Saved accuracy calibration plot to results/plots/CNN_binary_images+tab100_train_val_acc_separate.png")
