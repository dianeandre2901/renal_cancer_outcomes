...
for epoch in range(epochs):
    ...
    plt.tight_layout()
    plt.savefig(f"results/plots/CNN_binary_images100_slide_confusion_matrix_epoch{epoch + 1}.png")
    plt.close(fig)
    print(f"Saved confusion matrix as results/plots/CNN_binary_images100_slide_confusion_matrix_epoch{epoch + 1}.png/pdf")
...
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images100_final_slide_ROC.png")
plt.close()
print("Saved final ROC curve as results/plots/CNN_binary_images100_final_slide_ROC.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images100_train_val_loss_acc.png")
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images100_train_val_loss_separate.png")
plt.close()
print("Saved loss calibration plot to results/plots/CNN_binary_images100_train_val_loss_separate.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("results/plots/CNN_binary_images100_train_val_acc_separate.png")
plt.close()
print("Saved accuracy calibration plot to results/plots/CNN_binary_images100_train_val_acc_separate.png")
...
# Save to file
with open("results/plots/CNN_binary_images100_runtime_aftertuning.txt", "w") as f:
